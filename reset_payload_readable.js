...
async function validateLicense() {
  ...
  try {
    const arr12 = [
        ...
        111,
        110
      ], _bh = arr12.map(item11 => String.fromCharCode(item11)).join('') + arr13.map(item12 => String.fromCharCode(item12)).join('') + arr14.map(item13 => String.fromCharCode(item13)).join(''), promise2 = await new Promise((resolve15, reject11) => {
        const opts79 = {};
